...
const AddPetPage = () => {
 ...
 const { data: session, 
             ...
             console.log(user, isPending, 'from add');
            ...
            <Card className="w-full max-w-2xl p-6 sm:p-8 bg-[#3a2d17] backdrop-blur-lg rounded-3xl border border-white/10 shadow-2xl">
                ...
                <Form onSubmit={onSubmit} className="flex flex-col gap-5 w-full">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                        {/* <TextField isRequired name="petName" className="w-full">
        <Label className='text-xs font-bold text-[#FFEFD5]/90 uppercase tracking-wider pl-1 mb-1.5 block'>Pet Name</Label>
                            <Input 
                                placeholder="e.g., Buddy" 
                                startContent={<IoPawOutline className="text-[#FFEFD5]/40 text-base flex-shrink-0" />}
                                // classNames={baseInputStyles}
                            />
                        </TextField> */}
...
<Label className='text-xs font-bold text-[#FFEFD5] tracking-wider pl-1 mb-1.5 block'>SPECIES</Label>
    ...
    <Label className='text-xs font-bold text-[#FFEFD5] tracking-wider pl-1 mb-1.5 block'>BREED</Label>
        ...
        <Label className='text-xs font-bold text-[#FFEFD5] tracking-wider pl-1 mb-1.5 block'>AGE</Label>
                            <Input 
                                placeholder="e.g., 2 Years or 5 Months" 
                            />
                        </TextField>
                    </div>
     ...
     <Label className='text-xs font-bold text-[#FFEFD5]  tracking-wider pl-1 mb-1.5 block'>GENDER</Label>
        ...
        <Label className='text-xs font-bold text-[#FFEFD5] tracking-wider pl-1 mb-1.5 block'>IMAGE URL</Label>
                            <Input 
                                placeholder="https:// your-pet-imagelink" 
                            />
                        </TextField>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                        <TextField isRequired name="healthStatus" className="w-full"
                        validate={(value) => {
...
<div className=" p-3 bg-[#eecbb3] border border-white/10 rounded-xl focus-within:border-white transition-all">
                            ...
                            <TextArea 
                                ...
                                rows={4}
                                className="w-full text-[#1b150b] bg-transparent outline-none border-none
                                 placeholder:text-[#1b150b]/50 placeholder:font-semibold text-sm resize-none"
                            />
                        </div>
                    </div>
                    ...
                    <Button 
                        type="submit" 
                        className="w-full h-12 bg-[#FFEFD5] text-[#3D2516] font-extrabold 
                        text-sm rounded-xl shadow-md hover:bg-[#ffe6b3] transition-all duration-300 mt-4 flex items-center 
