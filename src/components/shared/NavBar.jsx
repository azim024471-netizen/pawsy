    ...
    <nav className="bg-[#FFEFD5] border-b border-[#3D2516]/10 text-[#3D2516] sticky top-0 z-50 backdrop-blur-md bg-opacity-95 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <Link href="/" className="flex items-center gap-1 md:gap-2 group select-none">
          ...
          <div className="flex items-center gap-5 sm:gap-8 overflow-x-auto no-scrollbar py-2 max-w-[50%] sm:max-w-none">
          ...
          <div className="flex items-center">
            {isPending ? (
              <div className="flex items-center gap-1 md:gap-2 bg-[#3D2516]/5 md:px-4 px-3 py-1 md:py-2 rounded-xl border border-[#3D2516]/10">
                ...
                {user ? (
                  <div className="relative" ref={dropdownRef}>
                    <button
                      ...
                      className="flex items-center gap-2 hover:bg-[#3D2516]/5 px-3 py-2 rounded-xl transition-all duration-200"
                    >
                      <Avatar size="md">
                        <Avatar.Image
                  ...
                  <>
                    <div className="md:hidden relative" ref={mobileMenuRef}>
                      <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="p-1">
                        {mobileMenuOpen ? <CgClose size={30} /> : <RxDropdownMenu size={30} />}
                      </button>
                      
                      {mobileMenuOpen && (
                        <div className="absolute -right-3 mt-4 w-40 bg-white border border-[#3D2516]/10 rounded-2xl shadow-xl overflow-hidden py-1 z-50 animate-in fade-in slide-in-from-top-4 duration-200">
                          <Link
                            href="/auth/signup"
                            onClick={() => setMobileMenuOpen(false)}
                            className="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-[#381905] hover:bg-[#FFEFD5]/40 transition-colors"
                          >
                            <LuUserRoundPen />
                            Sign Up
                          </Link>
                          ...
                          <Link
                            href="/auth/signin"
                            onClick={() => setMobileMenuOpen(false)}
                            className="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-[#0dbd24] hover:bg-[#FFEFD5]/40 transition-colors"
                          >
                            <PiSignInBold />
                            Sign In
                          </Link>
